...
plt.plot(dates, y_pred, label='Gradient Boost Predicted Price', alpha=0.7)
plt.legend()
plt.title('KO Stock Price Prediction: Gradient Boosting Regression')
plt.xlabel('Date')
plt.ylabel('Price')
...
plt.title('Gradient Boosting Prediction Residuals: Actual - Predicted')
plt.xlabel('Date')
plt.ylabel('Error')
plt.legend()
plt.tight_layout()
