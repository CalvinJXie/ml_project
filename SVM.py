...
plt.plot(dates, y_pred, label='SVM Predicted Price', alpha=0.7)
plt.legend()
plt.title('KO Stock Price Prediction: SVM Regression')
plt.xlabel('Date')
plt.ylabel('Price')
...
plt.title('SVM Prediction Residuals: Actual - Predicted')
plt.xlabel('Date')
plt.ylabel('Error')
plt.legend()
plt.tight_layout()
